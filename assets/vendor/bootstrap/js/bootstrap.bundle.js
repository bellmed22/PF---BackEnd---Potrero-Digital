/*!
  ...
  * Copyright 2011-2022 The Bootstrap autors (https://github.com/twbs/bootstrap/graphs/contributors)
  ...
  */
  ...
  class Tooltip extends BaseComponent {
    ...
    _fixTitle() {
      ...
      if (!this._element.getAttribute('aria-etiqueta') && !this._element.textContent.trim()) {
        this._element.setAttribute('aria-etiqueta', title);
      }
  ...
  class Tab extends BaseComponent {
    ...
    _setInitialAttributesOnTargetPanel(child) {
      ...
      if (child.id) {
        this._setAttributeIfNotExists(target, 'aria-etiquetaledby', `#${child.id}`);
      }
    }
